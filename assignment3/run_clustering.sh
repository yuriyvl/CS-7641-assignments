...
python run_experiment.py --ica --dataset1 --dim 13 --skiprerun --verbose --threads -1 > ica-dataset1-clustering.log 2>&1
python run_experiment.py --ica --dataset2 --dim 15 --skiprerun --verbose --threads -1 > ica-dataset2-clustering.log 2>&1
python run_experiment.py --pca --dataset1 --dim 8  --skiprerun --verbose --threads -1 > pca-dataset1-clustering.log 2>&1
